...
import Accordions from "./courses/Accordions";
const Teacher = () => {
  return (
      ...
      <div className="grid sm:grid-cols-2 place-items-center  gap-8">
        <div className="pl-5">
          ...
          <p className="text-sm leading-7 text-gray mb-5">
            ...
            quis corrupti, esse amet modi neque accusamus odit quasi saepe
            possimus vel totam, dolor omnis debitis inventore voluptatum alias
            rerum doloremque!
          </p>
